...
from terms_TaylorSeries import *
#==============================================================================
def SM( domain_I , domain_theta ,step_1 ):
    ...
    for I in domain_I:
        ...
        for theta in domain_theta:
            value_of_tau = assign_tau( I , theta,r )
            poin_fun_theta.append(red_poi_fun(I, theta , value_of_tau,r) )
            dotI_theta.append( dot_I( I , theta, value_of_tau , r) )
...
#
    ...
    levels_h = energies(0.1,theta_H(0.1), 100 , 0.01)
    ...
    plt.contour( x , y , z_1 , levels = [ 0 ] , colors = 'yellow' , linestyles = 'solid' )
